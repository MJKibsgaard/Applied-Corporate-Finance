### First part is to get the data. It should be easily scalable. We can just add tickers to expand the model
...
print(backtest_results['META'].tail())
...
def construct_portfolio(test_data, model, features):
    ...
    # For each day, pick the top 2 stocks with highest predicted returns
    ...
    for date in top_stocks.index:
        ...
        portfolio_daily_returns.append(avg_return / 2)  # Take average of the two returns
